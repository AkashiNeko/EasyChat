...
public class UserThread extends Thread {
    ...
    public UserThread(int port, String username) {
        ...
        try {
            ...
            Logger.println(port + ": " + e.getMessage());
        }
    }
    ...
    public void run() {
        ...
        try {
            ...
            Logger.println("\033[32mclient login: user \"" + username + "\" login, port=" + port + "\033[0m");
            ...
            Logger.println("debug: " + onlineFriends);
            if (onlineFriends != null) {
                for (String onlineFriend : onlineFriends) {
                    ...
                    pw.println(sendMsg);
                    Logger.println("\033[34m" + username + " -> " + onlineFriend + ": \"" + sendMsg + "\"\033[0m");
                }
            }
            while (true) {
            ...
            try {
                ...
                Logger.println("\033[33mclient close: user \"" + username + "\" offline. port=" + port + "\033[0m");
            } catch (Exception e) {
                Logger.println(port + ": " + e.getMessage());
            }
        }
